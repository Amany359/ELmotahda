! function() {
    ...
    function I() {
        ...
        var e = document.documentElement.clientWidth,
            e = (e < 1025 && 767 < e ? (document.body.classList.remove("twocolumn-panel"), "twocolumn" == localStorage.getItem("data-layout") && (document.documentElement.setAttribute("data-layout", "twocolumn"), document.getElementById("customizer-layout03") && document.getElementById("customizer-layout03").click(), v(), A(), f()), "vertical" == localStorage.getItem("data-layout") && document.documentElement.setAttribute("data-sidebar-size", "sm"), "semibox" == localStorage.getItem("data-layout") && document.documentElement.setAttribute("data-sidebar-size", "sm"), document.querySelector(".hamburger-icon") && document.querySelector(".hamburger-icon").classList.add("open")) : 1025 <= e ? (document.body.classList.remove("twocolumn-panel"), "twocolumn" == localStorage.getItem("data-layout") && (document.documentElement.setAttribute("data-layout", "twocolumn"), document.getElementById("customizer-layout03") && document.getElementById("customizer-layout03").click(), v(), A(), f()), "vertical" == localStorage.getItem("data-layout") && document.documentElement.setAttribute("data-sidebar-size", localStorage.getItem("data-sidebar-size")), "semibox" == localStorage.getItem("data-layout") && document.documentElement.setAttribute("data-sidebar-size", localStorage.getItem("data-sidebar-size")), document.querySelector(".hamburger-icon") && document.querySelector(".hamburger-icon").classList.remove("open")) : e <= 767 && (document.body.classList.remove("vertical-sidebar-enable"), document.body.classList.add("twocolumn-panel"), "twocolumn" == localStorage.getItem("data-layout") && (document.documentElement.setAttribute("data-layout", "vertical"), k("vertical"), f()), "horizontal" != localStorage.getItem("data-layout") && document.documentElement.setAttribute("data-sidebar-size", "lg"), document.querySelector(".hamburger-icon")) && document.querySelector(".hamburger-icon").classList.add("open"), document.querySelectorAll("#navbar-nav > li.nav-item"));
        Array.from(e).forEach(function(e) {
    ...
    function q(e) {
        if (e == e) {
            switch (e["data-layout"]) {
                case "vertical":
                    T("data-layout", "vertical"), localStorage.setItem("data-layout", "vertical"), document.documentElement.setAttribute("data-layout", "vertical"), k("vertical"), f();
                    break;
                case "horizontal":
                    T("data-layout", "horizontal"), localStorage.setItem("data-layout", "horizontal"), document.documentElement.setAttribute("data-layout", "horizontal"), k("horizontal");
                    break;
                case "twocolumn":
                    T("data-layout", "twocolumn"), localStorage.setItem("data-layout", "twocolumn"), document.documentElement.setAttribute("data-layout", "twocolumn"), k("twocolumn");
                    break;
                case "semibox":
                    T("data-layout", "semibox"), localStorage.setItem("data-layout", "semibox"), document.documentElement.setAttribute("data-layout", "semibox"), k("semibox");
                    break;
                default:
                    "vertical" == localStorage.getItem("data-layout") && localStorage.getItem("data-layout") ? (T("data-layout", "vertical"), localStorage.setItem("data-layout", "vertical"), document.documentElement.setAttribute("data-layout", "vertical"), k("vertical"), f()) : "horizontal" == localStorage.getItem("data-layout") ? (T("data-layout", "horizontal"), localStorage.setItem("data-layout", "horizontal"), document.documentElement.setAttribute("data-layout", "horizontal"), k("horizontal")) : "twocolumn" == localStorage.getItem("data-layout") ? (T("data-layout", "twocolumn"), localStorage.setItem("data-layout", "twocolumn"), document.documentElement.setAttribute("data-layout", "twocolumn"), k("twocolumn")) : "semibox" == localStorage.getItem("data-layout") && (T("data-layout", "semibox"), localStorage.setItem("data-layout", "semibox"), document.documentElement.setAttribute("data-layout", "semibox"), k("semibox"))
            }
            ...
            switch (e["data-layout-mode"]) {
                case "light":
                    T("data-layout-mode", "light"), document.documentElement.setAttribute("data-layout-mode", "light"), localStorage.setItem("data-layout-mode", "light");
                    break;
                case "dark":
                    T("data-layout-mode", "dark"), document.documentElement.setAttribute("data-layout-mode", "dark"), localStorage.setItem("data-layout-mode", "dark");
                    break;
                default:
                    localStorage.getItem("data-layout-mode") && "dark" == localStorage.getItem("data-layout-mode") ? (localStorage.setItem("data-layout-mode", "dark"), document.documentElement.setAttribute("data-layout-mode", "dark"), T("data-layout-mode", "dark")) : (localStorage.setItem("data-layout-mode", "light"), document.documentElement.setAttribute("data-layout-mode", "light"), T("data-layout-mode", "light"))
            }
            ...
            switch (e["data-body-image"]) {
                case "img-1":
                    T("data-body-image", "img-1"), localStorage.setItem("data-sidebabodyr-image", "img-1"), document.documentElement.setAttribute("data-body-image", "img-1"), document.getElementById("theme-settings-offcanvas") && document.documentElement.removeAttribute("data-sidebar-image");
                    break;
                case "img-2":
