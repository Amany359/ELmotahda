...
<head>
        ...
        <style id="trackstore-elated-woo-inline-css" type="text/css">
                ...
                .page-id-1701.eltd-boxed .eltd-wrapper {
                ...
                .page-id-1701 .eltd-page-header .eltd-sticky-header .eltd-sticky-holder {
                        border-color: ;
                }
                ...
                .page-id-1701 .eltd-content .eltd-content-inner>.eltd-container>.eltd-container-inner,
                .page-id-1701 .eltd-content .eltd-content-inner>.eltd-full-width>.eltd-full-width-inner {
                        padding-top: 0px;
                }
        </style>
        ...
        <script type="text/javascript" id="zxcvbn-async-js-extra">
                /* <![CDATA[ */
                var _zxcvbnSettings = {
                        "src": "https:\/\/trackstore.qodeinteractive.com\/wp-includes\/js\/zxcvbn.min.js"
                };
                /* ]]> */
        </script>
        <script type="text/javascript" src="{{url('website/wp-includes/js/zxcvbn-async.min5152.js')}}?ver=1.0" id="zxcvbn-async-js"></script>
        ...
        <script></script>
        <link rel="https://api.w.org/" href="{{url('website/wp-json/index.html')}}" />
        <link rel="alternate" type="application/json" href="{{url('website/wp-json/wp/v2/pages/1701.js')}}on" />
        <link rel="EditURI" type="application/rsd+xml" title="RSD" href="{{url('website/xmlrpc0db0.html')}}?rsd" />
        <meta name="generator" content="WordPress 6.3.4" />
        <meta name="generator" content="WooCommerce 8.1.1" />
        <link rel="canonical" href="index.html')}}" />
        <link rel="shortlink" href="{{url('website/index9cab.html')}}?p=1701" />
        <link rel="alternate" type="application/json+oembed" href="{{url('website/wp-json/oembed/1.0/embedb911.json')}}?url=https%3A%2F%2Ftrackstore.qodeinteractive.com%2Fcart%2F" />
...
<body class="page-template-default page page-id-1701 theme-trackstore eltd-core-1.2.5 eltd-social-login-1.2 eltd-toolbar-1.0 woocommerce-cart woocommerce-page woocommerce-no-js trackstore-ver-1.8 eltd-grid-1300 eltd-light-header eltd-enable-header-style-on-scroll eltd-sticky-header-on-scroll-down-up eltd-dropdown-animate-height eltd-header-standard eltd-menu-area-shadow-disable eltd-menu-area-in-grid-shadow-disable eltd-menu-area-border-disable eltd-menu-area-in-grid-border-disable eltd-logo-area-border-disable eltd-logo-area-in-grid-border-disable eltd-header-vertical-shadow-disable eltd-header-vertical-border-disable eltd-side-menu-slide-from-right eltd-woocommerce-page eltd-woocommerce-columns-3 eltd-woo-normal-space eltd-woo-pl-info-below-image eltd-woo-single-standard eltd-woo-single-thumb-on-left-side eltd-woo-single-has-photo-swipe eltd-default-mobile-header eltd-sticky-up-mobile-header eltd-fullscreen-search eltd-search-fade wpb-js-composer js-comp-ver-7.0 vc_responsive" itemscope itemtype="http://schema.org/WebPage">
                ...
                <div class="eltd-wrapper-inner">
                        ...
                        <div class="eltd-content">
                                <div class="eltd-content-inner">
                                        <div class="eltd-title-holder eltd-standard-with-breadcrumbs-type" style="height: 129px;" data-height="240">
                                                <div class="eltd-title-wrapper" style="height: 129px;">
                                                        <div class="eltd-title-inner">
                                                                <div class="eltd-grid">
                                                                        <div class="eltd-title-info">
                                                                                <h3 class="eltd-page-title entry-title">{{__("lan.Cart")}}</h3>
                                                                        </div>
                                                                        <div class="eltd-breadcrumbs-info">
                                                                                <div itemprop="breadcrumb" class="eltd-breadcrumbs ">
                                                                                        <a itemprop="url" href="{{route('index')}}">
                                                                                                {{__("lan.home")}}
                                                                                        </a>
                                                                                        <span class="eltd-delimiter">
                                                                                                &nbsp; / &nbsp;
                                                                                        </span>
                                                                                        <span class="eltd-current">
                                                                                                {{__("lan.Cart")}}
                                                                                        </span>
                                                                                </div>
                                                                        </div>
        ...
        <script type="text/javascript" src="{{url('website/wp-content/plugins/woocommerce/assets/js/frontend/country-select.min12c8.js')}}?ver=8.1.1" id="wc-country-select-js"></script>
        ...
        <script type="text/javascript" src="{{url('website/wp-content/plugins/woocommerce/assets/js/frontend/address-i18n.min12c8.js')}}?ver=8.1.1" id="wc-address-i18n-js"></script>
        <script type="text/javascript" id="wc-cart-js-extra">
                /* <![CDATA[ */
                var wc_cart_params = {
                        "ajax_url": "\/wp-admin\/admin-ajax.php",
                        "wc_ajax_url": "\/?wc-ajax=%%endpoint%%",
                        "update_shipping_method_nonce": "268fec08a5",
                        "apply_coupon_nonce": "66600db172",
                        "remove_coupon_nonce": "fe44fc3426"
                };
                /* ]]> */
        </script>
        <script type="text/javascript" src="{{url('website/wp-content/plugins/woocommerce/assets/js/frontend/cart.min12c8.js')}}?ver=8.1.1" id="wc-cart-js"></script>
        <script type="text/javascript" src="{{url('website/wp-content/plugins/woocommerce/assets/js/selectWoo/selectWoo.full.min1716.js')}}?ver=1.0.9-wc.8.1.1" id="selectWoo-js"></script>
        <script type="text/javascript" src="{{url('website/wp-includes/js/dist/vendor/wp-polyfill-inert.min0226.js')}}?ver=3.1.2" id="wp-polyfill-inert-js"></script>
        <script type="text/javascript" src="{{url('website/wp-includes/js/dist/vendor/regenerator-runtime.min8fa4.js')}}?ver=0.13.11" id="regenerator-runtime-js"></script>
        <script type="text/javascript" src="{{url('website/wp-includes/js/dist/vendor/wp-polyfill.min2c7c.js')}}?ver=3.15.0" id="wp-polyfill-js"></script>
        <script type="text/javascript" src="{{url('website/wp-includes/js/dist/hooks.min2ebd.js')}}?ver=c6aec9a8d4e5a5d543a1" id="wp-hooks-js"></script>
        <script type="text/javascript" src="{{url('website/wp-includes/js/dist/i18n.minf92f.js')}}?ver=7701b0c3857f914212ef" id="wp-i18n-js"></script>
        ...
        <script type="text/javascript" src="{{url('website/wp-admin/js/password-strength-meter.min11c9.js')}}?ver=6.3.4" id="password-strength-meter-js"></script>
        ...
        <script type="text/javascript" src="{{url('website/wp-content/plugins/woocommerce/assets/js/frontend/password-strength-meter.min12c8.js')}}?ver=8.1.1" id="wc-password-strength-meter-js"></script>
        ...
        <script type="text/javascript" src="http://maps.googleapis.com/maps/api/js?key=AIzaSyAGPipt5UdxUYhqXjaxQnq3uXwTzLNyIGw&amp;callback=eltdEmptyCallback&amp;ver=6.3.4" id="trackstore-elated-google-map-api-js"></script>
        ...
        <script>
                function cart_shop_data() {
                        const div = document.getElementById("cart_shop_data");
                        $.ajax({
                                type: "post",
                                url: "{{   route('cart_shop_data')   }}",
                                data: {
                                        "_token": "{{csrf_token()}}"
                                },
                ...
                cart_shop_data();
                function change_count_cart(ele, id, product_id) {
                        $.ajax({
                                type: "post",
                                url: "{{   route('change_count_cart')   }}",
                                data: {
                                        "_token": "{{csrf_token()}}",
                                        "id" : id,
                                ...
                                success: function(data) {
                                        if(data.status_code == 400){
                                                msg(data.msg, "{{__('lan.Failed')}}", 'error') ;
                                        }
                                        cart_shop_data();
                                        cart_shop(); 
                                },
