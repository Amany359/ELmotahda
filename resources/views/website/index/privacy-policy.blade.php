...
<head>
    ...
    <title>{{__("lan.Privacy Policy")}}</title>
                ...
                <div class="col-xl-5 col-lg-6 col-md-10">
                    <div class="header-campaign-activation axil-slick-arrow arrow-both-side header-campaign-arrow">
                        ...
                        @if(Lang::locale() == 'ar')
                            <div class="slick-slide">
                                <div class="campaign-content">
                                    <p style="color: white;">يمكنك طلب : <a href="#" > عرض سعر </a>من مركز الاداره الهندسية</p>
                                </div>
                            </div>
                            <div class="slick-slide">
                                <div class="campaign-content">
                        ...
                        @else
                            <div class="slick-slide">
                                <div class="campaign-content">
                                    <p style="color: white;">You can : <a href="#" > request a quote </a>from the Engineering Management Center</p>
                                </div>
                            </div>
                            <div class="slick-slide">
                                <div class="campaign-content">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-8">
                        <div class="inner">
                            <ul class="axil-breadcrumb">
                                ...
                                <li class="axil-breadcrumb-item active" aria-current="page">{{__("lan.Privacy Policy")}}</li>
                            </ul>
                            <h1 class="title">{{__("lan.Privacy Policy")}}</h1>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-4">
                        <div class="inner">
                            ...
                            @endif
                                <img src="{{url('store/assets/images/product/product-45.png')}}" alt="Image">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-10">
                        <div class="axil-privacy-policy">
                            <span class="policy-published">{{__("lan.This Privacy policy was published on")}} {{$privacy_policy->created_at}}</span>
                            <?php $lang = "text_" . Lang::locale() ; echo html_entity_decode($privacy_policy->$lang); ?>
                        </div>
                    </div>
                </div>
            </div>
