...
<head>
    ...
    <title>{{__("lan.delivery returns")}}</title>
                    ...
                    <div class="col-lg-6 col-md-8">
                        <div class="inner">
                            <ul class="axil-breadcrumb">
                                ...
                                <li class="axil-breadcrumb-item active" aria-current="page">{{__("lan.delivery returns")}}</li>
                            </ul>
                            <h1 class="title">{{__("lan.delivery returns")}}</h1>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-10">
                        <div class="axil-privacy-policy">
                            ...
                            <?php $lang = "delivery_" . Lang::locale() ; echo html_entity_decode($privacy_policy->$lang); ?>
                        </div>
                    </div>
                </div>
            </div>
