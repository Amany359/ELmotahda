                                              ...
                                              <tbody>
                                                <tr>
                                                  <td width="80" align="left">
                                                    <img width="80" style="display:block;width:62%;max-width:80px;" alt="img" src="https://seveneg.com/images/logos/white_logo.png">
                                                  </td>
                                                  <td>&nbsp;</td>
                                                  <td align="right" style="font-family:'Open Sans', Arial, Helvetica, sans-serif;font-size: 14px;color: #ffffff;"><a href="{{route('contact')}}" target="_blank" style="color: #ffffff">Help Center</a></td>
                                                </tr>
                                              </tbody>
                                            </table>
                                          </td>
    ...
    <tbody>
      <tr>
        <td bgcolor="#f6f6f4" align="center">
            <table class="row" style="width:540px;max-width:540px;" width="540" cellspacing="0" cellpadding="0" border="0"
              align="center">
              <tbody>
                <tr>
                  <td class="container-padding" align="center">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      <td align="center"><img width="100"
                                          style="display:block;width:100%;max-width:100px;" alt="img"
                                          src="http://emailmug.com/premium-template/emailpaws/notif/ck.png"></td>
                                    </tr>
                                    <tr>
                                      <td height="20">&nbsp;
                                      </td>
                                    ...
                                    <tr>
                                      <td align="center"
                                        ...
                                        {{__("lan.Payment Successful_info")}} </td>
                                    </tr>
                                    <tr>
                                      <td height="30">&nbsp;
                                      </td>
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td>
                                            <table border="0" width="100%" cellpadding="0" cellspacing="0" align="center">
                                              <tbody>
                                                <tr>
                                                  <td style="font-family:'Open Sans', Arial, Helvetica, sans-serif;font-size: 13px;color: #282828;">Order id #{{$token}}</td>
                                                  <td width="30">&nbsp;</td>
                                        ...
                                        @foreach ($orders as $order)
                                            ...
                                            @php
                                              ...
                                              if(strpos($order->product_discount, "%") !== false){
                                                  $discount_number = str_ireplace("%", "", $order->product_discount);
                                                  $per = (100 - $discount_number) / 100 ; 
                                                  $product_before =  $order->product_price / $per ; 
                                              }else{
                                                  $product_before =  $order->product_discount + $order->product_price ; 
                                              }
                                              ...
                                              if(strpos($order->product_discount, "%") !== false){
                                                  $discount_number = str_ireplace("%", "", $order->product_discount);
                                                  $Discount += (($product_before * $order->order_quantity) * $discount_number)  / 100 ; 
                                              }elseif($order->product_discount >= 1){
                                                  $Discount += $order->product_discount * $order->order_quantity ; 
                                              }else{
                                                  $Discount += $order->product_discount * $order->order_quantity ; 
                                              }
                                              
                                              
                                              $sub_total += $order->product_price * $order->order_quantity ; 
                                              $total_before += $product_before * $order->order_quantity ; 
                                            ...
                                            <td>
                                                ...
                                                <tbody>
                                                    ...
                                                    <td width="250">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                            <td style="font-family:'Josefin Sans', Arial, Helvetica, sans-serif;font-size: 18px;color: #282828;line-height: 21px;">{{$order->product_name}}</td>
                                                            </tr>
                                                            <tr>
                                                            <td style="font-family:'Open Sans', Arial, Helvetica, sans-serif;font-size: 14px;color: #282828;line-height: 21px;">{{__("lan.Quantityproducts")}} : {{$order->order_quantity}}</td>
                                                            </tr>
                                                    ...
                                                    <td align="right" width="60">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                            <td align="right" style="font-family:'Open Sans', Arial, Helvetica, sans-serif;font-size: 14px;color: #282828;">{{$product_before}} EGP</td>
                                                            </tr>    
                                                        </tbody>
                                                        </table>
                                                    </td>
                                            ...
                                            <table border="0" width="280" cellpadding="0" cellspacing="0">
                                              <tbody>
                                                <tr>
                                                  ...
                                                  <td>&nbsp;</td>
                                                  <td align="right" style="font-family:'Open Sans', Arial, Helvetica, sans-serif;font-size: 14px;color: #282828;">{{$total_before}} EGP</td>
                                                </tr>
                                                <tr>
                                                            ...
                                                            {{-- <table border="0" width="200" cellpadding="0" cellspacing="0" align="center">
                                                              <tbody>
                                                                <tr>
                                                                  ...
                                                                  <tr>
                                                                    <td style="font-family:'Josefin Sans', Arial, Helvetica, sans-serif;font-size: 18px;color: #282828;">{{__("lan.Billing Address")}}</td>
                                                                  </tr>
                                                                  <tr>
                                                                    <td height="18">&nbsp;</td>
                                                                  </tr>
                                                                  <tr>
                                                                    <td style="font-family:'Open Sans', Arial, Helvetica, sans-serif;font-size: 13px;color: #282828;line-height: 22px;">{{$order->country}} 
                                                                      <br>
                                                                      {{$order->town}} 
                                                                      <br>{{$order->address1}} 
                                                                      <br>{{$order->address2}}
                                                                  ...
                                                                  <tr>
                                                                    <td style="font-family:'Josefin Sans', Arial, Helvetica, sans-serif;font-size: 18px;color: #282828;">{{__("lan.Shipping Method")}}</td>
                                                                  </tr>
                                                                  <tr>
                                                                    <td height="18">&nbsp;</td>
                                                                  </tr>
                                                                  <tr>
                                                                    <td style="font-family:'Open Sans', Arial, Helvetica, sans-serif;font-size: 13px;color: #282828;">Priority Mail Express International</td>
                                                                  </tr>
