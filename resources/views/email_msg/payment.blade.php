...
@endif
    ...
    <!--module-->
    <table style="width:100%;max-width:100%;direction:{{$dir}} ; text-align:start;" width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
      <tbody>
        <tr>
                                  ...
                                  <td align="center">
                                    ...
                                    <table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="width:100%; max-width:100%;">
                                      <tbody>
                                        ...
                                        <tr>
                                          <td align="center" style="font-family:'Josefin Sans', Arial, Helvetica, sans-serif;font-size: 30px;color: #282828;">{{__("lan.Purchase in progress")}}</td>
                                        </tr>
                                        <tr>
                                          <td height="18">&nbsp;</td>
                                        </tr>
                                        <tr>
                                          <td align="center" style="font-family:'Josefin Sans', Arial, Helvetica, sans-serif;font-size: 24px;color: #282828;">{{__("lan.Thanks for your purchase")}} </td>
                                        </tr>
                                        <tr>
                                          <td height="18">&nbsp;</td>
                                        </tr>
                                        ...
                                        <tr>
                                          <td align="center">
                                            ...
                                            <!--button-->
                                            <table border="0" bgcolor="#9c8563" cellpadding="0" cellspacing="0">
                                              <tbody>
                                                <tr>
                                                  ...
                                                  <td align="center" height="40" width="170" style="font-family:'Open Sans', Arial, Helvetica, sans-serif;font-size: 13px;color: #ffffff;font-weight: 600;letter-spacing: 0.5px;">
                                                    ...
                                                    <a href="{{route('shop')}}" target="_blank" style="color: #ffffff">{{__("lan.Return to shop")}}</a>
                                                  </td>
                                        ...
                                        <tr>
                                          {{-- <td align="center" style="font-family:'Open Sans', Arial, Helvetica, sans-serif;font-size: 15px;color: #282828;">or <a href="http://www.emailpaws.com" target="_blank" style="color: #282828"><u>View your order</u></a></td> --}}
                                        </tr>
                                        <tr>
                                          <td height="30">&nbsp;</td>
                                        </tr>
                                        ...
                                        <tr>
                                          <td>
                                            <table border="0" width="100%" cellpadding="0" cellspacing="0" align="center">
                                              <tbody>
                                                <tr>
                                                  <td style="font-family:'Open Sans', Arial, Helvetica, sans-serif;font-size: 13px;color: #282828;">Order id #{{$order_id}}</td>
                                                  <td width="30">&nbsp;</td>
                                        ...
                                        @foreach ($carts as $cart)
                                            ...
                                            @php
                                              ...
                                              if(strpos($cart->discount, "%") !== false){
                                                  ...
                                                  $before = $cart->product_price / $per ; 
                                                  $Discount += ( $before - $cart->product_price ) *  $cart->cart_quantity ; 
                                              }else{
                                            ...
                                            <td>
                                                ...
                                                <tbody>
                                                    ...
                                                    <td align="right" width="60">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                            <td align="right" style="font-family:'Open Sans', Arial, Helvetica, sans-serif;font-size: 14px;color: #282828;">{{$cart->product_price}} EGP</td>
                                                            </tr>    
                                                        </tbody>
                                                        </table>
                                                    </td>
                                                            ...
                                                            <table border="0" width="200" cellpadding="0" cellspacing="0" align="center">
                                                              <tbody>
                                                                <tr>
                                                                  ...
                                                                  <tr>
                                                                    <td style="font-family:'Josefin Sans', Arial, Helvetica, sans-serif;font-size: 18px;color: #282828;">Shipping Company</td>
                                                                  </tr>
                                                                  <tr>
                                                                    <td height="18">&nbsp;</td>
                                                                  </tr>
                                                                  <tr>
                                                                    <td style="font-family:'Open Sans', Arial, Helvetica, sans-serif;font-size: 13px;color: #282828;">Mylerz</td>
                                                                  </tr>
