...
<head>
  ...
  <title>{{__("lan.Add Project")}}</title>
          ...
          <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
            <div class="card-body px-4 py-3">
              <div class="row align-items-center">
                <div class="col-9">
                  <h4 class="fw-semibold mb-8">{{__("lan.Add Project")}}</h4>
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      <li class="breadcrumb-item">
                        <a class="text-muted text-decoration-none" href="{{route('Dashboard')}}">{{__("lan.home")}}</a>
                      </li>
                      <li class="breadcrumb-item" aria-current="page">{{__("lan.Add Project")}}</li>
                    </ol>
                  </nav>
                </div>
                <div class="col-3">
            ...
            <div class="row">
              <div class="col-lg-8 ">
                  ...
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-7">
                      ...
                      <div class="mb-4">
                        ...
                        <input type="text" name="title_ar" class="form-control data_inputs" placeholder="{{__("lan.title")}}">
                      ...
                      <div class="mb-4">
                        ...
                        <input type="text" name="title_en" class="form-control data_inputs" placeholder="{{__("lan.title")}}">
                        <p class="fs-2">{{__("lan.field is required")}}</p>
                      </div>
                      
                      <div class="snow-editor" style="height: 300px;">
                        <p>{{__("lan.description")}} (Arabic)</p>
                      </div>
              
                 
                      <div class="snow-editor" style="height: 300px;">
                        <p>{{__("lan.description")}} (English)</p>
                      </div>
                  ...
                  <div class="card-body">
                    <h4 class="card-title mb-7">{{__("lan.content")}}</h4>
                      ...
                      <div class="email-repeater mb-3">
                        ...
                        <div class="snow-editor" style="height: 300px;">
                          <p>{{__("lan.content")}} (Arabic)</p>
                        </div>
                
                   
                        <div class="snow-editor" style="height: 300px;">
                          <p>{{__("lan.content")}} (English)</p>
                        </div>
                ...
                <div class="form-actions mb-5" style="display: flex; justify-content: flex-start; align-items: center;">
                  <button type="button" onclick="add_project()" class="btn btn-primary" style="    margin: 0px 17px;">
                    {{__("lan.Save Changes")}}
                  </button>
      ...
      for (let i = 0; i < data_inputs.length; i++) {
        if(data_inputs[i].value != ""){
          ...
          if(count == data_inputs.length){
            let data_form = new FormData($("#add_project")[0]);
              $.ajax({
                  type:"post",
